...
def run_pair_alignment (seq, blast_db, num_threads, e_value_min, bitscore_cutoff, ids_to_recs, blastp, needle, dump_dir):
...
if __name__=="__main__":
    ...
    #        print( "[DETECT]: Analyzing {} ({}/{}) ...".format(seq.name(), i + 1, len(sequences)))
        ...
        if(process_counter >= 20 or true_job_count == number_of_seqs):
