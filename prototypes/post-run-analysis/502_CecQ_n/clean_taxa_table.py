...
if __name__ == "__main__":
    ...
    print("family read sum:", family_df["Reads"].sum())
    ...
    print("order read sum:", order_df["Reads"].sum())
    ...
    print("class read sum:", class_df["Reads"].sum())
    ...
    print("phylum read sum:", phylum_df["Reads"].sum())
    ...
    print("kingdom read sum:", kingdom_df["Reads"].sum())
