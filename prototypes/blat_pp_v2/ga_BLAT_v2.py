...
def get_contig2read_map(contig2read_file):
...
def get_gene2read_map(gene2read_file):
...
def process_blat(read_file, BLAT_tab_file, output_file, prev_mapping_count):
    mapped_reads = set()
    gene2read_map = dict()
...
if __name__ == "__main__":
    ...
    contig2read_map = get_contig2read_map(contig2read_file)
    gene2read_map, BWAreads = get_gene2read_map(gene2read_file)
