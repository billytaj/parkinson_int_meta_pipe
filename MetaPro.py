...
def main(config_path, pair_1_path, pair_2_path, single_path, contig_path, output_folder_path, threads, args_pack, tutorial_mode):
    ...
    GA_final_merge_mem_threshold   = int(paths.GA_final_merge_mem_threshold)
    ...
    GA_final_merge_job_limit    = int(paths.GA_final_merge_job_limit)
    ...
    GA_final_merge_job_delay    = float(paths.GA_final_merge_job_delay)
    ...
    print("GA final merge job delay:",  GA_final_merge_job_delay)
