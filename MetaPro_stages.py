...
class mp_stage:
    def __init__ (self, config_path, pair_1_path, pair_2_path, single_path, output_folder_path, read_mode, threads, args_pack, tutorial_mode_string = None):
        #make our util obj
    ...
    def tutorial_rRNA(self):
        print(dt.today(), "working on:", self.tutorial_string)
        rRNA_filter_path = os.path.join(self.output_folder_path, self.rRNA_filter_label)
