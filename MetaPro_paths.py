...
class tool_path_obj:
    def __init__ (self, config_path):
        ...
        if config:
            ...
            self.Barrnap        = config["Tools"]["Barrnap"]        if config["Tools"]["Barrnap"]           or config["Tools"]["Barrnap"]           == "" else os.path.join(tool_path, "Barrnap/barrnap")
            ...
            self.Barrnap        = os.path.join(tool_path, "Barrnap/barrnap")
