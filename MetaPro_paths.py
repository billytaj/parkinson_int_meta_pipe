...
class tool_path_obj:
    def __init__ (self, config_path):
        ...
        if config:
            ...
            self.Prot_DB = config["Databases"]["Prot_DB"] if config["Databases"]["Prot_DB"] or config["Databases"]["Prot_DB"] == "" else os.path.join(database_path, "diamond_v0922/nr")
            ...
            self.Prot_DB = os.path.join(database_path, "diamond_v0922/nr")
