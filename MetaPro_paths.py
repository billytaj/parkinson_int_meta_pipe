...
class tool_path_obj:
    def __init__ (self, config_path):
        ...
        if config:
            ...
            self.Detect         = config["Tools"]["Detect"]         if config["Tools"]["Detect"]            or config["Tools"]["Detect"]            == "" else os.path.join(script_path, "Detect_2.2.6.py")
            ...
            self.Detect         = os.path.join(script_path, "Detect_2.2.6.py")
