...
class tool_path_obj:
    ...
    def __init__ (self, config_path):
        ...
        self.Map_reads_gene_BLAT        = os.path.join(script_path, "ga_BLAT_generic_v2_a.py")
        self.Map_reads_prot_DMND        = os.path.join(script_path, "ga_Diamond_generic_v2_a.py")
        ...
        ga_diamond_sensitivity_default = "normal"
        ...
        if config:
            ...
            self.ga_diamond_sensitivity = ga_diamond_sensitivity_default
